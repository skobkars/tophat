...
SOUNDS = fail insert remove beep_bweep beep_clear beep_drip traffic one_oclock two_oclock three_oclock four_oclock five_oclock six_oclock seven_oclock eight_oclock nine_oclock ten_oclock eleven_oclock twelve_oclock
...
ifeq ($(TESTING),y)
	$(Q)ln -s ../../../../../../android/src/testing $(@D)/src/org/tophat
